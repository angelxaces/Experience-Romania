...
?>
    ...
    <!-- Le styles -->
    <link href="<?php echo base_url(); ?>/assets/hero_files/bootstrap.css" rel="stylesheet">
	...
	<meta property="og:image" content="<?php echo base_url(); ?>/assets/img/facebook-thumb.png"/>
	<link rel="image_src" href="<?php echo base_url(); ?>/assets/img/facebook-thumb.png" />
	<style type="text/css">
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <img src="<?php echo base_url(); ?>/assets/img/logo.png" style="float:left;margin-top:5px;z-index:5" alt="logo"/>
